...
import getirhacktathon.getirandroid.util.DataParser;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent pointsDataIntent = getIntent();
        LatLng source = pointsDataIntent.getParcelableExtra("SOURCE");
        LatLng destination = pointsDataIntent.getParcelableExtra("DESTINATION");
